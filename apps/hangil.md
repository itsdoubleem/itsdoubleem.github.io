...
verify:
  - claim: It works with no connection.
    how: Open it once with a connection, then turn airplane mode on and open it again. The course, the vocabulary, the exam papers and the review deck all still work. The whole app is 266 KB and your browser keeps a copy after the first visit.
